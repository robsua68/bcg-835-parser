...
import pandas as pd
from bcg_edi_835_parser import segments
...
from bcg_edi_835_parser.segments.financial_information import FinancialInformation as FinancialInformationSegment
...
class TransactionSet:
    ...
    def build_attribute(cls, segment: Optional[str], segments: Iterator[str]) -> BuildAttributeResponse:
        ...
        if identifier == FinancialInformationSegment.identification:
            ...
            return BuildAttributeResponse('financial_information', financial_information, None, segments)
